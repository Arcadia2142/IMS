...
#define DEFAULT_CHARS_PER_LINE 120
...
class StatisticPrinter{
    public:
        ...
        enum { Statistics = 1, Transactions = 2, Places = 4, Transitions = 8, Edges = 16, All = 31 } TInfoTypes;
        ...
        StatisticPrinter( Simulator *simulator );
        virtual ~StatisticPrinter();
        
        /** Výpis statistik. */
        void printStatistics( unsigned int statistic = All );
    protected:
        //Uložení transakcí.
