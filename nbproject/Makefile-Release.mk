...
${OBJECTDIR}/LamdaEvent.o: LamdaEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LamdaEvent.o LamdaEvent.cpp
...
${OBJECTDIR}/StatisticPrinter.o: StatisticPrinter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StatisticPrinter.o StatisticPrinter.cpp
